...
#[derive(Debug)]
pub struct ForkWeightProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ForkWeightProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ForkWeight processing");
    
    let mut processor = ForkWeightProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ForkWeightProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ForkWeightProcessor::new(false);
